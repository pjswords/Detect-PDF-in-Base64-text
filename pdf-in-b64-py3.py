...
# The script was written for Python 3 uses PyPDF2 to extract text 
...
if b64Hit:
    ...
    if pdfHit:
        ...
        print('END: ' + pdfHit.group(1)[len(pdfHit.group(1)) - 100 : \
            len(pdfHit.group(1))])
        # Decode Base64
        ...
        # Write the extracted text to a file with UTF-8 encoding. Attempting 
        # to write this text as ASCII will throw an error.
        try:
